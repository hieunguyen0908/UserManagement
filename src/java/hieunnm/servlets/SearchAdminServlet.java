...
public class SearchAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (roleID.getName().equals("admin")) {
                ...
                // get admin
                if (nameAdmin == null) {
                    List<AdminDTO> listAdmin = userDao.searchAdmin("");
                    if (listAdmin != null) {
                        request.setAttribute("SEARCH_RESULT_ADMIN", listAdmin);
                    }
                } else {
                    List<AdminDTO> listAdmin = userDao.searchAdmin(nameAdmin);
                    if (listAdmin != null) {
                        request.setAttribute("SEARCH_RESULT_ADMIN", listAdmin);
                    }
                }
                ...
                if (nameAdmin == null) {
                    UserDAO userDao = new UserDAO();
                    List<AdminDTO> listAdmin = userDao.searchAdmin(yourName);
                    if (listAdmin != null) {
                        request.setAttribute("SEARCH_RESULT_ADMIN", listAdmin);
                    }
                } else {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchAdminServlet.class.getName()).log(Level.SEVERE, null, ex);
